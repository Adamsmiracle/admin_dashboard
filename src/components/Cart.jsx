...
const Cart = () => {
  const { currentColor, cartDisplay, setCartDisplay, cartDropDown } = useStateContext();

  return (
    <div className={`bg-half-transparent h-0 w-full fixed nav-item top-0 right-0 `}>
      <div className="float-right h-screen  duration-1000 ease-in-out dark:text-gray-200 transition-all dark:bg-[#484B52] bg-white md:w-400 p-8">
        <div className="flex justify-between items-center">
          ...
          <Button
            ...
            size="2xl"
            borderRadius="50%"
            doSomething={() => setCartDisplay(false)}
          />
        </div>
